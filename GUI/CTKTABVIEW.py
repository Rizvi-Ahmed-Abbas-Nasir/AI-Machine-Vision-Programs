...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        notebook = customtkinter.CTkTabview(self, width=800, height=500, fg_color="#29292a")  # 262628 alternate Color
        notebook.add(" Home ")
        ...
        notebook.place(x=200,y=50)
        notebook._segmented_button.grid(sticky="W")

        ImageHome = customtkinter.CTkImage(dark_image=PIL.Image.open("images.jpg"), size=(400, 300))
